...
One could, of course, do something quite similar, with the litElement (or hyperHTMLElement or a Stencil component, or a nutmet component, etc), as is described in the React document above, only substituting litElement for React.
