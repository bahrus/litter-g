...
`;const importAttr=this.getAttribute("import");if(null!==importAttr)importPaths=self[importAttr];const count=LitterG._count++,scriptInfo=this.getScript(srcS),args=1<scriptInfo.args.length?"{"+scriptInfo.args.join(",")+"}":"input",text=`
${importPaths}
